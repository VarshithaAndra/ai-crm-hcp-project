...
The system persists interactions with the following schema:

| Field | Type | Description |
| :--- | :--- | :--- |
| `id` | Integer | Primary Key |
| `hcp_name` | String | Name of the Healthcare Professional |
| `interaction_type` | String | e.g., Visit, Call, Email |
| `attendees` | Text | List of participants |
| `topics` | Text | Key discussion points |
| `materials` | Text | Educational literature provided |
| `samples` | Text | Product samples distributed |
| `sentiment` | String | AI-detected emotional tone (Positive/Neutral/Negative) |
| `outcomes` | Text | Agreed results and conclusions |
| `follow_up` | Text | Action items and future dates |
